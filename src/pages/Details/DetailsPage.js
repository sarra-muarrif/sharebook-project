...
import BookGridDetails from "../../components/bookGridDetails/BookGridDetails";
        ...
        <div className="container">
          ...
          <div className="book-overview">   
           <h2 className="book-title">{props.books[0].title}</h2>
            <h2 className="book-price">{props.books[0].price}{<span><img src={ImgStar} alt="star" width="30px"/><img src={ImgStar} alt="star" width="30px"/><img src={ImgStar} alt="star" width="30px"/></span>}</h2>
